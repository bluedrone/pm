...
import com.wdeanmedical.pm.util.PDFCreater;
...
public class NEMMGBillingPDF {
	...
	public void createMGMBillingPDF(MGMBillingInfo bInfo, String fileName)
		...
		PDFCreater pdfCreater = new PDFCreater(fileName);
		...
		pdfCreater.drawText(fontBold, FONT_NORMAL, COLUMN1_X, y,
				"Patient Info:");
		y -= CHAR_HEIGHT;
		pdfCreater.drawText(fontNormal, FONT_NORMAL, COLUMN1_X, y,
				bInfo.getPatientName());
		y -= CHAR_HEIGHT;
		pdfCreater.drawText(fontNormal, FONT_NORMAL, COLUMN1_X, y,
				bInfo.getPatientAddress1());
		if (bInfo.getPatientAddress2() != null) {
			y -= CHAR_HEIGHT;
			pdfCreater.drawText(fontNormal, FONT_NORMAL, COLUMN1_X, y,
					bInfo.getPatientAddress2());
		}
		y -= CHAR_HEIGHT;
		...
		y -= CHAR_HEIGHT;
		pdfCreater.drawText(fontNormal, FONT_NORMAL, COLUMN1_X, y, "DOB: "
				+ bInfo.getPatientDOB());
		y -= CHAR_HEIGHT;
		pdfCreater.drawText(fontNormal, FONT_NORMAL, COLUMN1_X, y, "Sex: "
				+ bInfo.getPatientSex());
		...
		pdfCreater.drawText(fontBold, FONT_NORMAL, COLUMN2_X, y,
		...
		pdfCreater.drawText(fontNormal, FONT_NORMAL, COLUMN1_X + 35, dosY,
				bInfo.getDateOfService());

		// Write Facility Information
		pdfCreater.drawText(fontBold, FONT_NORMAL, COLUMN2_X, FACILITY_Y,
				"Facility:");
		...
		pdfCreater.drawText(fontNormal, FONT_NORMAL, COLUMN2_X + 45,
				FACILITY_Y, str);

		// Write Doctors Information
		pdfCreater.drawText(fontNormal, FONT_NORMAL, COLUMN2_X, dosY,
				"Guarantor: " + bInfo.getGuarantor());
		pdfCreater.drawText(fontNormal, FONT_NORMAL, COLUMN2_X, dosY
				- CHAR_HEIGHT, "Provider: " + bInfo.getProvider());
		...
		pdfCreater.drawTable(COLUMN1_X, CPT_Y, 50, content, CHAR_HEIGHT,
				FONT_NORMAL, false, true);
		...
		pdfCreater.drawText(fontBold, FONT_NORMAL, DIAG_COLUMN_X, CPT_Y,
				"Diagnotics");
		pdfCreater.drawTable(DIAG_COLUMN_X, CPT_Y - CHAR_HEIGHT, 60, content,
				CHAR_HEIGHT, FONT_NORMAL, false, false);
