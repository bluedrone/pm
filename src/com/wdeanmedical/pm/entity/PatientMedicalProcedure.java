...
public class PatientMedicalProcedure extends BaseEntity implements Serializable {
  ...
  public int hashCode() {
    ...
    result = prime * result + ((lastDone == null) ? 0 : lastDone.hashCode());
    result = prime * result + ((medicalProcedure == null) ? 0 : medicalProcedure.hashCode());
  ...
  public String toString() {
    return "PatientMedicalProcedure [patient=" + patient + ", medicalProcedure=" + medicalProcedure + ", status="
