...
public class PatientMedicalHistory extends BaseEntity implements Serializable {
  ...
  public String toString() {
    return "PatientMedicalHistory [patient=" + patient + ", clinician=" + clinician + ", date=" + date
        + ", encounterMedicationList=" + encounterMedicationList + ", pastSM=" + pastSM + ", famHist=" + famHist
