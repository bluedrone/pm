...
public class PatientMedicalHistory extends BaseEntity implements Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PatientMedicalHistory other = (PatientMedicalHistory) obj;
		if (allergDrug == null) {
		...
		if (encounterMedicationList == null) {
			...
			return false;
		if (Float.floatToIntBits(etohUnitsWeek) != Float
				.floatToIntBits(other.etohUnitsWeek))
			return false;
		if (famHist == null) {
		...
		if (patient == null) {
			...
			return false;
		if (Float.floatToIntBits(smokePksDay) != Float
				.floatToIntBits(other.smokePksDay))
			return false;
		if (Float.floatToIntBits(smokeYearsQuit) != Float
				.floatToIntBits(other.smokeYearsQuit))
			return false;
		if (subst == null) {
			if (other.subst != null)
				return false;
		...
		if (vaccNotes == null) {
			...
			return false;
		if (Float.floatToIntBits(yearsSmoked) != Float
				.floatToIntBits(other.yearsSmoked))
			return false;
		return true;
	}
	...
	public String toString() {
		return "PatientMedicalHistory [patient=" + patient + ", clinician="
				+ clinician + ", date=" + date + ", encounterMedicationList="
				+ encounterMedicationList + ", pastSM=" + pastSM + ", famHist="
				+ famHist + ", famHistOther=" + famHistOther
				+ ", famHistNotes=" + famHistNotes + ", allergFood="
				+ allergFood + ", allergDrug=" + allergDrug + ", allergEnv="
				+ allergEnv + ", vacc=" + vacc + ", vaccNotes=" + vaccNotes
				+ ", subst=" + subst + ", smokePksDay=" + smokePksDay
				+ ", yearsSmoked=" + yearsSmoked + ", smokeYearsQuit="
				+ smokeYearsQuit + ", etohUnitsWeek=" + etohUnitsWeek
