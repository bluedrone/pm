...
public class PatientFollowUp extends BaseEntity implements Serializable {
	...
	public String toString() {
		return "PatientFollowUp [patient=" + patient + ", clinician="
				+ clinician + ", date=" + date + ", followUpDate="
				+ followUpDate + ", level=" + level + ", when=" + when
				+ ", condition=" + condition + ", dispenseRx=" + dispenseRx
				+ ", USS=" + USS + ", pregnant=" + pregnant + ", woundCare="
				+ woundCare + ", refToSpecialist=" + refToSpecialist
				+ ", dentalList=" + dentalList + ", physiotherapy="
				+ physiotherapy + ", bloodLabs=" + bloodLabs + ", other="
				+ other + ", pulmonaryFXTest=" + pulmonaryFXTest + ", vision="
				+ vision + ", completed=" + completed + ", notes=" + notes
				+ "]";
	}
