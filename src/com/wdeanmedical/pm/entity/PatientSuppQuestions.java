...
public class PatientSuppQuestions extends BaseEntity implements Serializable {
  ...
  public void setEncounterQuestionList(List<EncounterQuestion> encounterQuestionList) {
  ...
  public int hashCode() {
    ...
    result = prime * result + ((encounterQuestionList == null) ? 0 : encounterQuestionList.hashCode());
    result = prime * result + ((numCupsCoffee == null) ? 0 : numCupsCoffee.hashCode());
    result = prime * result + ((numCupsTea == null) ? 0 : numCupsTea.hashCode());
    result = prime * result + ((numCupsWater == null) ? 0 : numCupsWater.hashCode());
  ...
  public String toString() {
    return "PatientSuppQuestions [patient=" + patient + ", clinician=" + clinician + ", date=" + date
        + ", numCupsWater=" + numCupsWater + ", numCupsCoffee=" + numCupsCoffee + ", numCupsTea=" + numCupsTea
        + ", waterSource=" + waterSource + ", encounterQuestionList=" + encounterQuestionList + "]";
  }
