...
public class Clinician extends BaseEntity implements Serializable {
  ...
  public int hashCode() {
    ...
    result = prime * result + ((practiceName == null) ? 0 : practiceName.hashCode());
  ...
  public String toString() {
    return "Clinician [username=" + username + ", password=" + password + ", firstName=" + firstName + ", middleName="
        + middleName + ", lastName=" + lastName + ", primaryPhone=" + primaryPhone + ", secondaryPhone="
        + secondaryPhone + ", groupName=" + groupName + ", practiceName=" + practiceName + ", email=" + email
        + ", fax=" + fax + ", pager=" + pager + ", role=" + role + ", division=" + division + ", department="
        + department + ", credential=" + credential + ", active=" + active + ", purged=" + purged + ", salt=" + salt
        + ", authStatus=" + authStatus + ", sessionId=" + sessionId + ", lastLoginTime=" + lastLoginTime
        + ", previousLoginTime=" + previousLoginTime + ", adminUser=" + adminUser + "]";
  }
